...
```console
uv pip install --python uv run python -r src/spider_forge/requirements-test.txt

uv pip check --python uv run python
uv run python -m compileall -q src/spider_forge crawler/news_crawler
uv run python -m pytest -q src/spider_forge/tests crawler/tests
```
...
```console
uv run python -m spider_forge.tests.manual.run_one_stage prepare --input src/spider_forge/tests/manual/rba_request.json --output src/spider_forge/runtime/manual/rba/01_prepare.json
uv run python -m spider_forge.tests.manual.run_one_stage recon --input src/spider_forge/runtime/manual/rba/01_prepare.json --output src/spider_forge/runtime/manual/rba/02_recon.json
uv run python -m spider_forge.tests.manual.run_one_stage triage --input src/spider_forge/runtime/manual/rba/02_recon.json --output src/spider_forge/runtime/manual/rba/03_triage.json
uv run python -m spider_forge.tests.manual.run_one_stage strategy --input src/spider_forge/runtime/manual/rba/03_triage.json --output src/spider_forge/runtime/manual/rba/04_strategy.json
uv run python -m spider_forge.tests.manual.run_one_stage evidence --input src/spider_forge/runtime/manual/rba/04_strategy.json --output src/spider_forge/runtime/manual/rba/05_evidence.json
uv run python -m spider_forge.tests.manual.run_one_stage generate --input src/spider_forge/runtime/manual/rba/05_evidence.json --output src/spider_forge/runtime/manual/rba/06_generate.json
uv run python -m spider_forge.tests.manual.run_one_stage preflight --input src/spider_forge/runtime/manual/rba/06_generate.json --output src/spider_forge/runtime/manual/rba/07_preflight.json
uv run python -m spider_forge.tests.manual.run_one_stage fixture --input src/spider_forge/runtime/manual/rba/07_preflight.json --output src/spider_forge/runtime/manual/rba/08_fixture.json
```
