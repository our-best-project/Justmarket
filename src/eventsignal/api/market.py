...
from eventsignal.core.cache import TTLCache, cache_ttl_seconds
from eventsignal.db.session import get_pooled_conn
...
# 資料源 Yahoo chart API，由 eventsignal.market_index.daily_batch 每日盤後 upsert 進兩張表：
...
# market_index_daily 由 eventsignal.market_index.daily_batch 每日盤後 upsert，盤中不會變
