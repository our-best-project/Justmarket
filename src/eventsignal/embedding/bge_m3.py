...
用法：
  python -m eventsignal.embedding.bge_m3 --limit 50
  python -m eventsignal.embedding.bge_m3 --device auto
  python -m eventsignal.embedding.bge_m3 --source json
"""
import argparse
import json
import os
...
# embedding → eventsignal → src → <repo>
