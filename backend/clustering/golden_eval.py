...
from backend.clustering.dedup import assemble_events, classify_periodic
from backend.embedding.bge_m3 import OUT_DIR as EMB_OUT
from backend.embedding.bge_m3 import fetch_pending_articles
